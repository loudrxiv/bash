...
ll
#1645588052
mv /mnt/c/Users/mork/Downloads/.doom.d/ /mnt/c/Users/mork/Downloads/bash/ ~
#1645588072
ll
#1645588074
cd bash/
...
ll
#1645588598
sudo apt install git pip pipenv texlive-full buld-essential graphviz gnuplot isync
#1645589331
ll
#1645589359
...
git add .
#1645590540
git commit -m "event more small changes"
#1645590548
git push -u origin main
#1645590559
cd
...
git add .
#1645629790
git -m commit "emacs acting weird"
#1645629815
git commit -m "emacs acting weird"
#1645629823
git config --global user.email mae117@pit.edu
#1645629827
git config --global user.email mae117@pitt.edu
#1645629835
git config --global user.name mebeid1
...
emax
#1645649732
cd home/mae117/cnt/seq_vae/src/R_models/seq-vae_mod-embed_tf/
#1645635057
dennis
#1645654138
emax
...
mkdir apks
#1645716429
mv /mnt/c/Users/mork/Downloads/F-Droid.apk  ~/apks/
#1645716430
cd
#1645716433
cd apks/
...
cd
#1645717183
mv apks/ /mnt/c/Users/mork/Documents/
#1645715225
dennis
#1645725481
cd
#1645725487
cd /mnt/c/Users/mork/Downloads/
#1645725525
scp Miniconda3-latest-Linux-x86_64.sh mae117@klaus.devbio.pitt.edu:~
#1645725715
dennis
#1645726871
man sed
...
tail -n +4 Supp-S1.t
#1645727297
tail -n +4 Supp-S1.txt 
#1645727320
head Supp-S1.txt 
#1645727341
tail -n +4 Supp-S1.txt  | head
#1645727368
cat Supp-S1.txt  grep "weak"
#1645727373
cat Supp-S1.txt | grep "weak"
#1645728384
cd /mnt/c/Users/mork/Downloads/
...
gzip Supp-S1.pdf 
#1645741243
gzip -d Salviato_etal_3DETG_2022-02-24.tsv.gz 
#1645741244
l
#1645741251
gzip -d Salviato_etal_3DETG_2022-02-24.tsv.gz 
...
cd .doom.d/
#1645827268
git clone --depth=1 https://gitlab.com/OlMon/org-habit-report.git
#1645827273
cd org-
#1645827278
cd org-habit-report/
...
pwd
#1645827326
/home/moo/.doom.d/org-habit-reportcd
#1645827327
cd
#1645827330
emax
...
#1645924551
sudo apt install libtool cmake gcc
#1645924571
sudo apt search vterm
#1645924593
sudo apt install  libvterm-dev
...
cd Sync/
#1645926887
cd org/academics/graduate/research/
#1645926892
cd akira/
#1645926895
cd akira-safe/
...
rm -rf ref/
#1645927347
cd academics/graduate/research/
#1645927353
cd akira/
#1645927357
cd imad/
...
cat akira.org 
#1645927428
mv akira.org akira2.org
#1645927435
mv imad.org akira.org
#1645927440
trash imad/
#1645927502
cd ..
...
git add .
#1646013546
git commit -m "added org ref info, but I will use zotero"
#1646013557
...
emacs
#1646019894
cd ~/Cache/Sync/org/academics/graduate/research/
#1646019899
mv akira/
#1646019906
cd akira/
...
cd
#1646020063
cd ~/Cache/Sync/org/academics/graduate/
#1646020065
cd research/
#1646020080
cd haiyi/
